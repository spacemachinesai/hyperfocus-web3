    ...
    <footer className="bg-volcanic text-white">
      ...
      <div className="container-web3 pt-12 md:pt-20 pb-12 md:pb-20">
          ...
          <div className="lg:col-span-4">
            ...
            <form onSubmit={handleSubmit} className="relative max-w-sm">
              <input
                ...
                className="w-full px-0 py-3 bg-transparent border-b border-white/30 text-white placeholder:text-neutral-65 focus:outline-none focus:border-white transition-colors"
                required
              />
              <button
                type="submit"
                className="absolute right-0 top-1/2 -translate-y-1/2 text-neutral-65 hover:text-white transition-colors"
                aria-label="Submit"
              >
                ...
                <ul className="space-y-3">
                  {links.map((link) => (
                    <li key={link.label}>
                      <Link
                        href={link.href}
                        className="text-web3-14 text-neutral-65 hover:text-white transition-colors"
                      >
                        {link.label}
                      </Link>
                    </li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          {/* Social Links - Left on mobile, Right on desktop */}
          <div className="flex items-center gap-4 order-2 md:order-1">
            <Link href="#" className="text-neutral-65 hover:text-white transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </Link>
            <Link href="#" className="text-neutral-65 hover:text-white transition-colors" aria-label="Discord">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="#" className="text-neutral-65 hover:text-white transition-colors" aria-label="X">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </Link>
            <Link href="#" className="text-neutral-65 hover:text-white transition-colors" aria-label="Email">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 order-1 md:order-2">
            ...
            <Link href="#" className="text-web3-14 text-neutral-65 hover:text-white transition-colors">
              Privacy
            </Link>
            <Link href="#" className="text-web3-14 text-neutral-65 hover:text-white transition-colors">
              Terms of Use
            ...
            <button className="text-web3-14 text-neutral-65 hover:text-white transition-colors flex items-center gap-1">
              English
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
